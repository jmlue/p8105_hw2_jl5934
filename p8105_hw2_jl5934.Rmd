...
To combine datasets, and retain all the information, we first do `full_join` with Mister and Professor Trash Wheel. Of note both Professor Trash wheel and Gwynnda have missing values (NA) for sports balls as they did not have that column to begin with, and glass bottles for Gqynnda as well has NA.
